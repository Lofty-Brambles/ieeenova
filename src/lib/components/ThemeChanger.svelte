<script lang="ts">
	...
	const onchange: ChangeEventHandler<HTMLInputElement> = (e) => {
		theme.current = e.currentTarget.checked ? "dark" : "light";
	};
</script>

<label class="theme-toggle" title="Toggle theme">
	<input type="checkbox" checked={theme.current === "dark"} {onchange} />
...
<style>
	...
	svg * {
		...
		transition: transform calc(var(--toggle-duration)) cubic-bezier(0, 0, 0, 1.25);
	}
